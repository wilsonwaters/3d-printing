...
Exact commands, capability detection, and per-version fallbacks: **[verification.md](#verification) — MANDATORY READ before verifying.** The deterministic checks:
...
- **[verification.md](#verification)** — MANDATORY READ: how to compile, render, visually inspect, and trace requirements with the OpenSCAD CLI (with version-specific fallbacks)
